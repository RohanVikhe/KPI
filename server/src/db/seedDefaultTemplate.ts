...
export const defaultTemplate = {
  ...
  formula: "(billability_utilization + delivery_excellence + quality_process + value_client) / 4",
  isActive: true,
  goals: [
    {
      key: "billability_utilization",
      name: "Billability & Utilization",
      description: "Ensure optimal utilization of delivery resources and maximize billable contribution.",
      weight: 1,
      formula: "(utilization_rate + billability_rate) / 2",
      metrics: [
        {
          key: "bu_billable_hours",
          label: "Billable Hours (Input)",
          type: MetricType.NUMBER,
          required: true,
          min: 0,
        },
        {
          key: "bu_available_hours",
          label: "Available Hours (Input)",
          type: MetricType.NUMBER,
          required: true,
          min: 1,
        },
        {
          key: "bu_total_working_hours",
          label: "Total Working Hours (Input)",
          type: MetricType.NUMBER,
          required: true,
          min: 1,
        },
        {
          ...
          isComputed: true,
          definition: "Measures the percentage of available working hours that are spent on billable activities.",
          formulaText: "(Billable Hours / Available Hours) * 100",
          calcFormula: "(bu_billable_hours / bu_available_hours) * 100",
          targetText: "Target Range: 90% - 100%; Acceptable: >= 85%",
          frequency: "Monthly",
          required: false,
          min: 0,
          max: 100,
        },
        {
          ...
          type: MetricType.PERCENT,
          isComputed: true,
          definition: "Measures percentage of total working time that is billable to clients.",
          formulaText: "(Billable Hours / Total Working Hours) * 100",
          calcFormula: "(bu_billable_hours / bu_total_working_hours) * 100",
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          label: "Scope Change Control Effectiveness (%)",
          type: MetricType.PERCENT,
          isComputed: true,
          definition: "Measures effectiveness of managing and controlling project scope changes.",
          formulaText: "(Approved and Controlled Scope Changes / Total Scope Change Requests) * 100",
          calcFormula: "(de_approved_scope_changes / de_total_scope_requests) * 100",
          targetText: "Stay above 80%",
          frequency: "Quarterly",
          required: false,
          min: 0,
          max: 100,
        ...
        },
        {
          ...
          targetText: "Stay below 2 escalations per measurement period; Preferred: <= 1 escalation",
          frequency: "Quarterly",
          required: false,
          min: 0,
        },
    ...
    },
    {
      ...
      weight: 1,
      formula:
        "(delivery_error_rework_rate + process_compliance_rate + change_management_adherence + automation_adoption) / 4",
      metrics: [
        {
          key: "qp_rework_count",
        ...
        {
          key: "qp_formal_changes",
          label: "Formally Managed Changes (Input)",
          type: MetricType.NUMBER,
          required: true,
          min: 0,
        },
        {
          key: "qp_total_changes",
          label: "Total Changes (Input)",
          type: MetricType.NUMBER,
          required: true,
          min: 1,
        },
        {
          ...
          label: "Projects Using Automation (Input)",
          type: MetricType.NUMBER,
          required: true,
          min: 0,
        },
        ...
        {
          key: "change_management_adherence",
          label: "Change Management Adherence (%)",
          type: MetricType.PERCENT,
          isComputed: true,
          definition: "Measures percentage of changes handled using formal change management process.",
          formulaText: "(Formally Managed Changes / Total Changes) * 100",
          calcFormula: "(qp_formal_changes / qp_total_changes) * 100",
          targetText: "Stay above 90%",
          frequency: "Quarterly",
          required: false,
          min: 0,
        ...
        },
        {
          ...
          type: MetricType.PERCENT,
          isComputed: true,
          definition: "Measures usage of automation in delivery activities.",
          formulaText: "(Projects Using Automation / Total Projects) * 100",
          calcFormula: "(qp_automated_projects / qp_total_projects) * 100",
          targetText: "Stay above 60%",
          frequency: "Yearly",
          required: false,
          min: 0,
          max: 100,
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          targetText: "Stay above 1 initiative per measurement period",
          frequency: "Quarterly",
          required: false,
          min: 0,
        },
        {
          ...
          targetText: "Stay above 4.2 out of 5",
          frequency: "Quarterly",
          required: false,
          min: 0,
          max: 5,
