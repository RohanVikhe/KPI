...
import { listTeamHandler, listUsersHandler, updateUserHandler, updateMyProfileHandler, updateMyPasswordHandler, deleteUserHandler, deleteUserKpiDataHandler, listUserKpiEntriesHandler, } from "../controllers/userController.js";
const router = Router();
...
router.delete("/:id/kpi/:submissionId", authenticate, requireRole(Role.ADMIN, Role.MANAGER), validateParams(kpiEntrySchema), deleteUserKpiDataHandler);
